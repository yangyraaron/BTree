...
${OBJECTDIR}/btree_pef_test.o: btree_pef_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/btree_pef_test.o btree_pef_test.c

${OBJECTDIR}/linklist.o: linklist.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/linklist.o linklist.c
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/ut_linklist.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.c}   -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS} -lcunit -lcunit -lcunit -lcunit -lcunit 


${TESTDIR}/tests/ut_btree.o: tests/ut_btree.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ut_btree.o tests/ut_btree.c


${TESTDIR}/tests/ut_linklist.o: tests/ut_linklist.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ut_linklist.o tests/ut_linklist.c
...
${OBJECTDIR}/btree_nomain.o: ${OBJECTDIR}/btree.o btree.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/btree_nomain.o btree.c;\
	else  \
...
${OBJECTDIR}/btree_pef_test_nomain.o: ${OBJECTDIR}/btree_pef_test.o btree_pef_test.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/btree_pef_test_nomain.o btree_pef_test.c;\
	else  \
...
${OBJECTDIR}/linklist_nomain.o: ${OBJECTDIR}/linklist.o linklist.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/linklist_nomain.o linklist.c;\
	else  \
